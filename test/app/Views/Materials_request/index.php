    ...
    $product_name=$row5['name']; 
      ...
      ?>
        <tr>
          ...
          <a class="btn btn-sm text-primary" onclick="window.location.href='https://intercol.betaholder.com/test/Materials_request/edit/<?php echo $materials['id']?>';"><i class="far fa-edit"></i>
