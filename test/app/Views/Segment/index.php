...
<div class="table-responsive">
   ...
   if($unit[0]['Segment_edit']=='1') 
   { ?> 
          
              
              
            <a class="btn btn-sm text-primary" title="Edit" data-toggle="modal" data-target="#material-edit-Modal" data-name="<?=$segment['seg_name']?>" data-href="<?=base_url('/Segment/edit/'.$segment['id'])?>">
              <i class="far fa-edit"></i>
            </a>
            
            	 <?php } if($unit[0]['Segment_delete']=='1') { ?>
            	 
            <a class="btn btn-sm text-danger" title="Delete" data-toggle="modal" data-target="#material-delete-Modal" data-href="<?=base_url('/Segment/delete/'.$segment['id'])?>" data-name="<?=$segment['seg_name']?>">
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <?php echo form_open(base_url('/Segment/add'), [
          'method' => 'post',
