...
.row::after {
 ...
 <?php 
	...
	<a  href="<?=base_url('/Jobcard/viewimages/'.$Jobs['id'])?>">	<img src="https://intercol.betaholder.com/test/Jobcard1/folder.png" alt="folder" style="height: 85px;"> </a><br>
	<?=$Jobs['folder_name']?></center>
	</div>
