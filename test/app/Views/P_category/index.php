...
<div class="table-responsive">
   ...
   if($unit1[0]['Product_c_edit']=='1') 
   { ?> 
         
              
              
            <a class="btn btn-sm text-primary" title="Edit" data-toggle="modal" data-target="#material-edit-Modal" data-name="<?=$unit['product_name']?>" data-href="<?=base_url('/P_category/edit/'.$unit['id'])?>">
              <i class="far fa-edit"></i>
            </a>
            	 <?php } if($unit1[0]['Product_c_delete']=='1') { ?>
            <a class="btn btn-sm text-danger" title="Delete" data-toggle="modal" data-target="#material-delete-Modal" data-href="<?=base_url('/P_category/delete/'.$unit['id'])?>" data-name="<?=$unit['product_name']?>">
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <?php echo form_open(base_url('/P_category/add'), [
          'method' => 'post',
