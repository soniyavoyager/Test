...
<div class="table-responsive">
    ...
    <tbody>
      ...
      foreach ($cmpny as $material):?>
        <tr>
          <td><?=$counter?></td>
          <td><?=$material['cmpny_name']?></td>
          <td>
                   	<?php 
   ...
   if($unit[0]['Com_edit']=='1') 
   { ?> 
              
            <a class="btn btn-sm text-primary" title="Edit" data-toggle="modal" data-target="#material-edit-Modal" data-name="<?=$material['cmpny_name']?>" data-href="<?=base_url('/Cmpny/edit/'.$material['id'])?>">
              <i class="far fa-edit"></i> </a>
            
            	 <?php } if($unit[0]['Com_delete']=='1') { ?>
	
            <a class="btn btn-sm text-danger" title="Delete" data-toggle="modal" data-target="#material-delete-Modal" data-href="<?=base_url('/Cmpny/delete/'.$material['id'])?>" data-name="<?=$material['cmpny_name']?>">
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <?php echo form_open(base_url('/Cmpny/add'), [
          'method' => 'post',
