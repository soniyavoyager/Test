...
<div class="table-responsive">
   ...
   if($unit[0]['plot_edit']=='1') 
   { ?>  
              
            <a class="btn btn-sm text-primary" title="Edit" data-toggle="modal" data-target="#material-edit-Modal" data-name="<?=$Purchase['purchase_mode']?>" data-href="<?=base_url('/Purchase/edit/'.$Purchase['purchase_id'])?>">
              <i class="far fa-edit"></i>
            </a>
             <?php } if($unit[0]['plot_delete']=='1') { ?>
            <a class="btn btn-sm text-danger" title="Delete" data-toggle="modal" data-target="#material-delete-Modal" data-href="<?=base_url('/Purchase/delete/'.$Purchase['purchase_id'])?>" data-name="<?=$Purchase['purchase_mode']?>">
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel">Add Purchase mode</h5>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">&times;</span>
        </button>
      </div>
      <div class="modal-body">
        <?php echo form_open(base_url('/Purchase/add'), [
          'method' => 'post',
