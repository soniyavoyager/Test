...
<div class="table-responsive">
   ...
   if($unit1[0]['unit_edit']=='1') 
   { ?> 
          
              
            <a class="btn btn-sm text-primary" title="Edit" data-toggle="modal" data-target="#material-edit-Modal" data-name="<?=$unit['name']?>" data-href="<?=base_url('/Unit/edit/'.$unit['id'])?>">
              <i class="far fa-edit"></i>
            </a>
            
              <?php } if($unit1[0]['unit_delete']=='1') { ?>
            <a class="btn btn-sm text-danger" title="Delete" data-toggle="modal" data-target="#material-delete-Modal" data-href="<?=base_url('/Unit/delete/'.$unit['id'])?>" data-name="<?=$unit['name']?>">
