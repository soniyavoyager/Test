    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <?php echo form_open(base_url('/materials/add'), [
		  ...
		  <select class="form-control" name="unit" id="exampleInputCategory" style="height: calc(2.25rem + 13px);" required>
		  ...
		  <select class="form-control" name="category" id="exampleInputCategory" style="height: calc(2.25rem + 13px);" required>
		  ...
		  <select class="form-control" name="Segment" id="exampleInputCategory" style="height: calc(2.25rem + 13px);" required>
          ...
          <div class="form-group">
            ...
            <!--<input type="number" name="rate" step=".01"  id="name" class="form-control required" required>-->
             ...
             <INPUT id="txtChar" onkeypress="return isNumberKey(event)" type="text" name="rate"  class="form-control required" required>
