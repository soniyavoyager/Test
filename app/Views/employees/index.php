      ...
      <div class="modal-body">
        ...
        <div class="form-group">
          ...
          <div class="form-group">
            ...
            <input type="text" onkeypress="return isNumberKey(event)"  name="phone"  class="form-control required" id="txtChar" required>
          </div>
          <div class="form-group">
          ...
          <div class="form-group">
            ...
            <!--<input type="number"  name="rate" step=".01" min="0"   class="form-control required">-->
             <INPUT id="txtChar" onkeypress="return isNumberKey(event)" type="text" name="rate"  class="form-control required">
            ...
            <label>Over Time1 Rate(Per hours)</label>
                ...
                <INPUT id="txtChar" onkeypress="return isNumberKey(event)" type="text" name="ot1_rate"  class="form-control required">
            
          </div>
            <div class="form-group">
            <label>Over Time2 Rate(Per hours)</label>
            <!--<input type="number" name="ot2_rate" id="rate" step=".01" min="0"    class="form-control required">-->
              <INPUT id="txtChar" onkeypress="return isNumberKey(event)" type="text" name="ot2_rate"  class="form-control required">
