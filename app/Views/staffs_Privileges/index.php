      ...
      foreach ($staffs as $key => $staff):?>
        <tr>
          <td><?=$counter?></td>
            ...
            <td><?php if($staff['s_id']=="hr") {echo("HR & Admin");}?> 
            <?php if($staff['s_id']=="manager") {echo("Manager");}?>
        <?php if($staff['s_id']=="accounts") {echo("Purachase & Accounts");}?> 
            <?php if($staff['s_id']=="supervisor") {echo("Supervisor");}?> </td>
            
          <td>
            <a class="btn btn-sm text-primary" title="Edit" data-toggle="modal" data-target="#staff-edit-Modal" data-name="<?echo ("Roles Edit");?>" data-href="<?=base_url('/Staff_roles/edit/'.$staff['id'])?>">
              <i class="far fa-edit"></i>
            </a>
            <!--<a class="btn btn-sm text-danger" title="Delete" data-toggle="modal"-->
            <!--data-target="#staff-delete-Modal" data-href="<?=base_url('/Staff_roles/delete/'.$staff['id'])?>" -->
            <!--data-name="<?echo ("Roles Delete");?>">-->
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel">Add Privileges</h5>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">&times;</span>
        </button>
      </div>
      <div class="modal-body" style="height: 450px;overflow-y: scroll;">
        <?php echo form_open(base_url('/Staff_roles/add'), [
          'method' => 'post',
          'id' => 'form-staff-add',
          ...
          <div class="form-group">
            ...
            <div class="form-group">
            <label><b>Work Status</b></label><br>
            <input type="checkbox" id="view-check" name="view11" value="1">
              <label for="view1" style="margin-right:1rem;"> View</label>
