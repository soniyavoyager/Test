...
echo form_open(base_url('/Staff_roles/update/'.$staff1[0]['id']), [
	'method' => 'post',
	'id' => 'form-staff-edit',
...
<div style="height: 450px;overflow-y: scroll;">
		  ...
		  <div class="form-group">
		    ...
		    <select name="position" id="position" class="form-control" readonly>
		      ...
		      <option value="manager" <?php if ($staff1[0]['s_id'] == 'manager'):?>selected <?php endif;?>>Manager</option>
		      <option value="HR" <?php if ($staff1[0]['s_id'] == 'hr'):?>selected <?php endif;?>>HR & Administrator</option>
		      
		        <option value="accounts" <?php if ($staff1[0]['s_id'] == 'accounts'):?>selected <?php endif;?>>Purachase & Accounts</option>
		      <option value="supervisor" <?php if ($staff1[0]['s_id'] == 'supervisor'):?>selected <?php endif;?>>Supervisor</option>
		    </select>
	...
	<div class="form-group">
          ...
          <div class="form-group">
           ...
           <label><b>Work Status</b></label><br>
            <input type="checkbox" id="view-check" name="view11" value="1"<?php if ($staff1[0]['work_st_view'] == '1'):?>checked <?php endif;?>>
              <label for="view1" style="margin-right:1rem;"> View</label>
	    </div>
